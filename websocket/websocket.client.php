...
class WebSocket implements WebSocketObserver {
	...
	protected function buildHeaderArray () {
		...
		$this->headers = array("GET"                   => "{$this->url} HTTP/1.1", "Connection:" => "Upgrade",
		                       "Host:"                 => "{$this->host}:{$this->port}",
		                       "Sec-WebSocket-Key:"    => "{$this->handshakeChallenge}",
		                       "Sec-WebSocket-Origin:" => "{$this->origin}", "Sec-WebSocket-Version:" => 8,
		                       "Upgrade:"              => "websocket",
		);
	...
	protected function buildHeaderArrayHixie76 () {
		...
		$this->headers = array("GET"                      => "{$this->url} HTTP/1.1", "Connection:" => "Upgrade",
		                       ...
		                       "Sec-WebSocket-Key2:"      => "{$this->hixieKey2->key}", "Upgrade:" => "websocket",
